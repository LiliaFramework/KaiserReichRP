...
-- @field ServerWorkshopID Determines the workshop collection for the server. This will enable a prompt asking you to download the collection. https://steamcommunity.com/sharedfiles/filedetails/?id=[id to be used] | **string**.
...
lia.config.GamemodeName = "KaiserReichRP"
